# 清河公开资料来源总表（Source Ledger）

> M-01 建立 · M-02 扩展（2026-08-23）· Mac
> ID 规范（H-M01-2）：`SRC-<PUBLISHER>-<SUBJECT>`，不再沿用迁移前旧名。
> 统计口径（H-M01-3）：**ledger entries（26 条）** vs **source documents/URLs（约 52 个，系列已展开）** 分开计数。
> 原则：每条注明「能证明什么 / 不能证明什么」。

## 统计

- ledger entries：26
- source documents / URLs：约 52（ali213 全流程 10 页、3dm 导航 16 页、bilibili 主线 3 视频、9game 命名变体 2 页等已展开）
- 来源分级：official 1 / walkthrough 16 / player 3 / community 5 / in_repo 1

## 来源清单

| id | kind | title | URL | 能证明（evidence roles） | 边界 / 不能证明 |
| --- | --- | --- | --- | --- | --- |
| SRC-YYSLCN-NARRATIVE-INTERVIEW | official | 大剧透！燕云没有主线剧情？体验式碎片化叙事是个啥（官方访谈） | https://www.yysls.cn/news/official/20230112/37780_1063057.html | IDENTITY（清河主线=少年遇江湖人）、HIDDEN_CLUE（暗线基于"清风驿之变"）、MOTIVATION（主线+暗线结构） | 不提供任务名/顺序；2023 旧文 |
...
| SRC-SOHU-MAIN-STORY | walkthrough | 全主线流程图文攻略（序章细节） | https://www.sohu.com/a/843193673_258858 | IDENTITY（序章：江晏/陈子奚/无相皇/16 年）、CHARACTER | 序章任务簿名称无记载 |
| SRC-18183-TASK-CATALOG | walkthrough | 全任务图文攻略汇总 | https://m.18183.com/xinyou/6886638.html | IDENTITY/HIERARCHY（清河残章/镇守）、ORDER（千夜于匹马映林嘶登场） | 与 ali213 归类部分不同 |
| SRC-BAIDU-PIMA | walkthrough | 匹马映林嘶任务流程（百度知道） | https://zhidao.baidu.com/question/438549348460245252.html | ORDER（篇二流程） | 标题级引用，未逐字复核 |
...
| SRC-BILIBILI-FOGUANG | player | 镇守·佛光顶（田英）BV1c8rnYuELj | https://www.bilibili.com/video/BV1c8rnYuELj/ | HIDDEN_CLUE（田英线锚点=镇守佛光顶） | 标题级 |
| SRC-BILIBILI-MINGAN-OPUS | player | 明暗故事·清河（bilibili 动态） | https://www.bilibili.com/opus/1023239554148073477 | IDENTITY（明暗故事·清河存在公开图文） | 抓取被验证码拦截；内容待人工/其他通道核阅 |
| SRC-TOUTIAO-WANGQING | community | 长枪守义…王清将军与乱世悲歌 | http://m.toutiao.com/group/7587009649925292580/ | MOTIVATION/FORESHADOWING（王清-主角身世作品化） | 社区分析 |
| SRC-QIEYOU-TIANYING | community | 田英背景故事（悬剑组织） | https://www.qieyou.com/content/114479 | HIDDEN_CLUE（田英/悬剑/历史原型） | 社区转述，高剧透（ID 已按发布者修正） |
| SRC-TOUTIAO-HONGXIAN | community | 悲情工具人红线，竟然也有历史原型 | http://m.toutiao.com/group/7474579165212181011/ | CHARACTER/MOTIVATION | 社区解读 |
| SRC-17173-SHAODONGJIA | community | 少东家身世大猜想（17173 专区） | https://news.17173.com/z/yy16s/（专区文章列表） | COMMUNITY_ALIAS（"少东家"）+ 身世猜测 | 社区讨论，不构成身份事实 |
| SRC-REPO-V5 | in_repo | content/yysls-qinghe-v5.json | 仓库内 | IDENTITY/TITLE/CHARACTER（项目已整理事件/角色） | 社区为主（21/24）；part 字段导入时被丢弃 |

## M-02 新增结论（evidence 摘要，已写入各 inventory）

1. **明潮/暗涌机制**（SRC-3DM-MINGAN-STORY / SRC-CHINA-MINGAN-STORY）：明潮=主线任务收集；暗涌=侠迹/镇守/万事知/偷听对话收集；明潮+暗涌集齐开地图终章动画。清河明线=千夜火烧不羡仙；暗线=燕北盟（王清/河东八骏）、活人医馆换脸之术（寒姨/天不收）、佛子妙善/田英刺契丹使者。→ 写入 hidden-story-inventory。
...
1. 天涯客身份/与"神秘的江湖人"对应（UQ-12，仍未找到直接来源）；
2. 寒香寻「洛神」身份公开考据（UQ-13）；
3. 绣金楼完整谱系（李祚/柳青衣）（UQ-14）；
4. 官方站更多章节/版本公告；
5. 明暗故事界面截图/图文（Windows W-01 优先）。
