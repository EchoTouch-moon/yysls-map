# 清河明/暗线（暗涌）关联候选（Hidden Story Inventory）

> M-01 · Mac · 明潮负责前进，暗涌负责补真相（Wave 1.6 P3）。
> 本表只列**候选关联**（CANDIDATE），不构成 canonical fact；确认需更强证据或 Windows 现场采集。
> 官方锚点：清河暗线基于历史「清风驿之变」（官方访谈 SRC-OFFICIAL-NARRATIVE）。

## 1. 暗线锚点（已确认 / 高置信）

| id | 暗线节点 | 内容摘要 | source | state |
| --- | --- | --- | --- | --- |
...
| id | 关联 | 候选方向 | 证据线索 | state |
| --- | --- | --- | --- | --- |
| HC-01 | 竹林旧居 ↔ 江晏前史/绣金楼 | 主角被养于竹林旧居是否与绣金楼追索有关 | v5 evt-prologue-escape（江晏携婴逃离绣金楼） | CANDIDATE |
| HC-02 | 百草野天涯客 ↔ 暗线引线 | 官方"神秘的江湖人"是否为暗线推手 | 官方访谈 + 攻略（天涯客） | CANDIDATE（未官方点名） |
| HC-03 | 不羡仙/寒姨 ↔ 洛神/换脸医师 | 寒香寻身份暗线（洛神、换脸）与清河地下势力 | v5 character han-xiangxun 标签；社区考据 | CANDIDATE |
| HC-04 | 活人医馆/弱水岸 ↔ 无面人/天不收/褚清泉 | 医馆井、无面人组织与寒姨关联 | v5 characters；匹马映林嘶攻略（弱水岸/无面人） | CANDIDATE |
| HC-05 | 田英线 ↔ 侠迹·终卷长夜有虹 / 镇守·佛光顶 | 田英暗线在探索内容中的载体 | bilibili BV1c8rnYuELj；3dm 3977244 导航 | CANDIDATE |
...
```text
                    [绣金楼/身世暗线]  ← 江晏前史
                         ╲
明潮 竹林旧居 ─ 断桥 ─ 北竹林 ─ 百草野 ─ 将军祠擂台（又见新来燕）
             ╲              ╲
        [江叔失踪]      [天涯客/江湖人 引线]
                         
后续篇（匹马映林嘶起）：[寒姨秘密] [无面人/弱水岸] [千夜/绣金楼] [不羡仙大火]
```

> 拓扑仅为研究层示意；产品表达（E3）与模型（E1）另行设计。

## 4. 数据缺陷记录（Data Defect，不顺手修解释层）
